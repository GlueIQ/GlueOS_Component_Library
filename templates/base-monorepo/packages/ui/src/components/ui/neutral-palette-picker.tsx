...
interface NeutralPalettePickerProps {
  value: NeutralPaletteName
  onChange: (name: NeutralPaletteName) => void
  className?: string
}

const PALETTE_NAMES: NeutralPaletteName[] = ['slate', 'gray', 'zinc', 'neutral', 'stone']

const SWATCH_SHADES = ['100', '300', '500', '700', '900'] as const

export function NeutralPalettePicker({ value, onChange, className }: NeutralPalettePickerProps) {
  return (
