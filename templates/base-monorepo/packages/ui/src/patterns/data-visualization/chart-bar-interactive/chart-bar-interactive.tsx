...
/**
 * ChartBarInteractive Pattern
 *
 * An interactive bar chart with series toggling and summary totals.
 * Accepts data, series, and display configuration as props.
 *
 * Composed of: Card, Chart from our component library + recharts
 * Source: shadcn/ui chart-bar-interactive (v4), extended with configurable API
...
export interface ChartBarInteractiveProps {
  ...
  /** Series definitions — one per bar group */
  series?: BarSeries[]
...
const defaultSeries: BarSeries[] = [
  { dataKey: "desktop", label: "Desktop", color: "var(--chart-2)" },
  { dataKey: "mobile", label: "Mobile", color: "var(--chart-1)" },
]
