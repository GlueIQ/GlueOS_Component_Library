 ...
 * Source: shadcn/ui chart-pie-interactive (v4)
...
export function ChartPieInteractive({ palette }: { palette?: ChromaticPaletteName } = {}) {
  ...
  // recharts v3 types don't include activeIndex/activeShape on Pie yet
  const pieExtras = {
    activeIndex,
    activeShape: ({
      outerRadius = 0,
